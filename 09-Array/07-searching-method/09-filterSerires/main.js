...
console.log(
  'array 3',
  array3.filter((item) => typeof item == 'number')
);
...
console.log(
  'array 4',
  array4.filter((item) => item.length > 6)
);
...
console.log(
  'array 7',
  array7.filter((item) => item.startsWith('E'))
);
...
console.log(
  'array 8',
  array8.filter((item) => item == item.toUpperCase())
);
...
console.log(
  'array 9',
  array9.filter((item) => item.toLowerCase().includes('buri'))
);
...
console.log(
  'array 10',
  array10.filter((item) => item.age > 18)
);
...
console.log(
  'array 12',
  array12.filter((item) => item.birth.slice(5, 7) != '06')
);
